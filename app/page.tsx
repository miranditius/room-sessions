...
<Link
  href="/"
  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/25 text-[10px] font-semibold leading-none tracking-widest text-white/90"
  aria-label="Room Sessions"
>
  RS
</Link>

    {/* Menú estilo Boiler Room */}
    <nav className="flex items-center gap-6 text-sm font-semibold uppercase tracking-wider text-white/90">
      <Link className="hover:text-white" href="/sesiones">Events</Link>
      <Link className="hover:text-white" href="/sesiones">Video</Link>
      <Link className="hover:text-white" href="#">Audio</Link>
      <Link className="hover:text-white" href="/para-venues">Venues</Link>
      <Link className="hover:text-white" href="#">Editorial</Link>
    </nav>
  </div>
</header>
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight md:text-6xl">
              Sesiones en vivo desde un venue realddfvdfdfv.
              <span className="text-white/70"> Cada sedfdfvdmana, un DJ distinto.</span>
            </h1>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20">
        <div className="mt-8 flex items-end justify-between gap-4">
          ...
          <div className="text-sm text-white/60">
            Demo reemplazable → luego multicámara + streaming
          </div>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm text-white/70">
              Mismo concepto, DJs rotativos, estética consistente.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm text-white/70">
              Clips cortos listos para IG/TikTok/Shorts.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mt-2 text-sm text-white/70">
              Licencia del formato a otros venues + plataforma central.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10 py-10 text-center text-xs text-white/50">
        © {new Date().getFullYear()} ROOMS SESSIONS • Piloto
      </footer>
    </main>
  );
}